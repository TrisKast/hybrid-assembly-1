...
To start using the hybrid-assembly pipeline, there are three steps described below:
...
```bash
wget https://github.com/kevinmenden/hybrid-assembly/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/hybrid-assembly-master
```
